                                                                                    ...
                                                                                    override fun onResourceReady(
                                                                                        ...
                                                                                        if (animationDrawable.numberOfFrames == it2.value.characterUri.size) {
                                                                                            ...
                                                                                            val charExp =
                                                                                                (100.0 * (userCharacter.exp.toFloat() - _exptable.value.exptable.requireexp2.toFloat())
                                                                                                        / (_exptable.value.exptable.requireexp1.toFloat() - _exptable.value.exptable.requireexp2.toFloat())).toLong()
                                                                                            binding.dashCharacterShopIvCharacter.minimumWidth = resource.width * PIXELS_PER_METRE
                                                                                            binding.dashCharacterShopIvCharacter.minimumHeight = resource.height * PIXELS_PER_METRE
                                                                                            binding.dashCharacterShopIvCharacter.setImageDrawable(animationDrawable)
                                                                                            animationDrawable = binding.dashCharacterShopIvCharacter.drawable as AnimationDrawable
                                                                                            animationDrawable.start()
                                                                                        }
                                                                                    }
                                                                                })
